...
var varTargetManagementGroupResourceId = tenantResourceId(
...
var varCustomPolicySetDefinitionsArray = [
  ...
  }
  {
    ...
    libSetChildDefinitions: [
      ...
      {
        definitionReferenceId: 'defenderForAI'
        definitionId: '/providers/Microsoft.Authorization/policyDefinitions/359a48a3-351a-4618-bb32-f1628645694b'
        definitionParameters: varPolicySetDefinitionEsDeployMDFCConfig_20240319Parameters.defenderForAI.parameters
        definitionGroups: []
        definitionVersion: '1.*.*'
      }
      {
      ...
      }
      {
        ...
        definitionId: '/providers/Microsoft.Authorization/policyDefinitions/5eb6d64a-4086-4d7a-92da-ec51aed0332d'
  ...
  }
  {
    ...
    libSetChildDefinitions: [
      ...
      {
        definitionReferenceId: 'EncryptedVMDisksEffectLin'
        definitionId: '/providers/Microsoft.Authorization/policyDefinitions/ca88aadc-6e2b-416c-9de2-5a0f01d1693f'
        definitionParameters: varPolicySetDefinitionEsEnforceEncryptionCMK_20250218Parameters.EncryptedVMDisksEffectLin.parameters
        definitionGroups: []
        definitionVersion: '1.*.*'
      }
      {
        definitionReferenceId: 'EncryptedVMDisksEffectWin'
        definitionId: '/providers/Microsoft.Authorization/policyDefinitions/3dc5edcd-002d-444c-b216-e123bbfa37c0'
        definitionParameters: varPolicySetDefinitionEsEnforceEncryptionCMK_20250218Parameters.EncryptedVMDisksEffectWin.parameters
        definitionGroups: []
        definitionVersion: '1.*.*'
      }
      {
  ...
  }
  {
    ...
    libSetDefinition: loadJsonContent('lib/policy_set_definitions/policy_set_definition_es_Enforce-Guardrails-Network_20250326.json')
    libSetChildDefinitions: [
      {
        ...
        definitionParameters: varPolicySetDefinitionEsEnforceGuardrailsNetwork_20250326Parameters['Deny-AppGw-Without-Tls'].parameters
        definitionGroups: []
        definitionVersion: '1.*.*'
      }
      {
        ...
        definitionParameters: varPolicySetDefinitionEsEnforceGuardrailsNetwork_20250326Parameters['Deny-AppGw-Without-Waf'].parameters
        definitionGroups: []
        definitionVersion: '2.*.*'
      }
      {
        ...
        definitionParameters: varPolicySetDefinitionEsEnforceGuardrailsNetwork_20250326Parameters['Deny-Ip-Forwarding'].parameters
        definitionGroups: []
        definitionVersion: '1.*.*'
      }
      {
        ...
        definitionParameters: varPolicySetDefinitionEsEnforceGuardrailsNetwork_20250326Parameters['Deny-Mgmt-From-Internet'].parameters
        definitionGroups: []
        definitionVersion: '1.*.*'
      }
      {
        ...
        definitionParameters: varPolicySetDefinitionEsEnforceGuardrailsNetwork_20250326Parameters['Deny-Nsg-GW-subnet'].parameters
        definitionGroups: []
        definitionVersion: '1.*.*'
      }
      {
        ...
        definitionParameters: varPolicySetDefinitionEsEnforceGuardrailsNetwork_20250326Parameters['Deny-Subnet-with-Service-Endpoints'].parameters
        definitionGroups: []
        definitionVersion: '1.*.*'
      }
      {
        ...
        definitionParameters: varPolicySetDefinitionEsEnforceGuardrailsNetwork_20250326Parameters['Deny-Subnet-Without-NSG'].parameters
        definitionGroups: []
        definitionVersion: '1.*.*'
      }
      {
        ...
        definitionParameters: varPolicySetDefinitionEsEnforceGuardrailsNetwork_20250326Parameters['Deny-Subnet-Without-Udr'].parameters
        definitionGroups: []
        definitionVersion: '1.*.*'
      }
      {
        ...
        definitionParameters: varPolicySetDefinitionEsEnforceGuardrailsNetwork_20250326Parameters['Deny-vNic-Pip'].parameters
        definitionGroups: []
        definitionVersion: '1.*.*'
      }
      {
        ...
        definitionParameters: varPolicySetDefinitionEsEnforceGuardrailsNetwork_20250326Parameters['Deny-VPN-AzureAD'].parameters
        definitionGroups: []
        definitionVersion: '1.*.*'
      }
      {
        ...
        definitionParameters: varPolicySetDefinitionEsEnforceGuardrailsNetwork_20250326Parameters['Deny-Waf-Afd-Enabled'].parameters
        definitionGroups: []
        definitionVersion: '1.*.*'
      }
      {
        ...
        definitionParameters: varPolicySetDefinitionEsEnforceGuardrailsNetwork_20250326Parameters['Deny-Waf-AppGw-mode'].parameters
        definitionGroups: []
        definitionVersion: '1.*.*'
      }
      {
        ...
        definitionId: '/providers/Microsoft.Authorization/policyDefinitions/564feb30-bf6a-4854-b4bb-0d2d2d1e6c66'
        definitionParameters: varPolicySetDefinitionEsEnforceGuardrailsNetwork_20250326Parameters['Deny-Waf-Fw-rules'].parameters
        definitionGroups: []
        definitionVersion: '2.*.*'
      }
      {
        ...
        definitionParameters: varPolicySetDefinitionEsEnforceGuardrailsNetwork_20250326Parameters['Deny-Waf-mode'].parameters
        definitionGroups: []
        definitionVersion: '1.*.*'
      }
      {
        ...
        definitionParameters: varPolicySetDefinitionEsEnforceGuardrailsNetwork_20250326Parameters['Modify-Nsg'].parameters
        definitionGroups: []
        definitionVersion: '1.*.*'
      }
      {
        ...
        definitionParameters: varPolicySetDefinitionEsEnforceGuardrailsNetwork_20250326Parameters['Modify-Udr'].parameters
        definitionGroups: []
        definitionVersion: '1.*.*'
      }
      {
        ...
        definitionParameters: varPolicySetDefinitionEsEnforceGuardrailsNetwork_20250326Parameters['Modify-vNet-DDoS'].parameters
        definitionGroups: []
        definitionVersion: '1.*.*'
      }
    ]
...
var varPolicySetDefinitionEsEnforceGuardrailsNetwork_20250326Parameters = loadJsonContent('lib/policy_set_definitions/policy_set_definition_es_Enforce-Guardrails-Network_20250326.parameters.json')
...
resource resPolicySetDefinitions 'Microsoft.Authorization/policySetDefinitions@2025-01-01' = [
  for policySet in varCustomPolicySetDefinitionsArray: {
    dependsOn: [
